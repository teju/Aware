...
import com.watch.aware.app.helper.BottomNavItemView
import com.watch.aware.app.helper.BottomNavItemViewTittle
...
class CurvedBottomNavigationView @JvmOverloads constructor(
    ...
    private val shadowColor: Int = Color.parseColor("#00000000")
