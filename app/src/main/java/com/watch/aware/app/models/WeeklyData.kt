...
class WeeklyData {
    ...
    fun getXAxisTempWeekly(activity: Context,type : String): MutableList<Entry> {
        this.activity = activity
        val values: MutableList<Entry> = ArrayList()
        values.add(Entry(1.0f, getWeeklyTempData(0, type)))
        values.add(Entry(2.0f, getWeeklyTempData(1, type)))
        values.add(Entry(3.0f, getWeeklyTempData(2, type)))
        values.add(Entry(4.0f, getWeeklyTempData(3, type)))
        values.add(Entry(5.0f, getWeeklyTempData(4, type)))
        values.add(Entry(6.0f, getWeeklyTempData(5, type)))
        values.add(Entry(7.0f, getWeeklyTempData(6, type)))
        return values
    }
    ...
    fun getWeeklyTempData(day : Int, type:String) :Float {
