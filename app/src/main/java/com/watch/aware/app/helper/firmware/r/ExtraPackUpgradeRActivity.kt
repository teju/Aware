...
class ExtraPackUpgradeRActivity : AppCompatActivity() {
...
//                    DfuAdapter.STATE_CONNECTING -> textView.text = "STATE_CONNECTING"
    ...
    fun upgrade(view: View) {
        DfuConfig().apply {
            ...
            otaWorkMode = DfuConstants.OTA_MODE_SILENT_FUNCTION
            isAutomaticActiveEnabled = false
            filePath = "sma_r5_language_zh_0010.bin"
