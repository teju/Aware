...
class MonthlyData {
    ...
    fun getXAxisHeartonthly(activity: Context,type : String): MutableList<Entry> {
        this.activity = activity
        val values: MutableList<Entry> = ArrayList()
        values.add(Entry(1.0f, getMonthlyHeartData(1, type,activity)))
        values.add(Entry(2.0f, getMonthlyHeartData(2, type, activity)))
        values.add(Entry(3.0f, getMonthlyHeartData(3, type, activity)))
        values.add(Entry(4.0f, getMonthlyHeartData(4, type, activity)))
        values.add(Entry(5.0f, getMonthlyHeartData(5, type, activity)))
        values.add(Entry(6.0f, getMonthlyHeartData(6, type, activity)))
        values.add(Entry(7.0f, getMonthlyHeartData(7, type, activity)))
        values.add(Entry(8.0f, getMonthlyHeartData(8, type, activity)))
        values.add(Entry(9.0f, getMonthlyHeartData(9, type, activity)))
        values.add(Entry(10.0f, getMonthlyHeartData(10, type, activity)))
        values.add(Entry(11.0f, getMonthlyHeartData(11, type, activity)))
        values.add(Entry(12.0f, getMonthlyHeartData(12, type, activity)))
        return values
    }
    ...
    fun getXAxisTempMonthly(activity: Context,type : String): MutableList<Entry> {
        this.activity = activity
        val values: MutableList<Entry> = ArrayList()
        values.add(Entry(1.0f, getMonthlyTempData(1, type, activity!!)))
        values.add(Entry(2.0f, getMonthlyTempData(2, type, activity!!)))
        values.add(Entry(3.0f, getMonthlyTempData(3, type, activity!!)))
        values.add(Entry(4.0f, getMonthlyTempData(4, type, activity!!)))
        values.add(Entry(5.0f, getMonthlyTempData(5, type, activity!!)))
        values.add(Entry(6.0f, getMonthlyTempData(6, type, activity!!)))
        values.add(Entry(7.0f, getMonthlyTempData(7, type, activity!!)))
        values.add(Entry(8.0f, getMonthlyTempData(8, type, activity!!)))
        values.add(Entry(9.0f, getMonthlyTempData(9, type, activity!!)))
        values.add(Entry(10.0f, getMonthlyTempData(10, type, activity!!)))
        values.add(Entry(11.0f, getMonthlyTempData(11, type, activity!!)))
        values.add(Entry(12.0f, getMonthlyTempData(12, type, activity!!)))
        return values
    }
    fun getMonthlyTempData(month: Int, type: String, activity: Context) :Float {

        val dataBaseHelper =
            DataBaseHelper(this.activity!!)
        var stepsCnt = 0.0
    ...
    fun getMonthlyHeartData(month: Int, type: String, activity: Context) :Float {
